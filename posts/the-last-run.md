...
title: "The Last Run"
date: 2026-09-20
description: "The last 20x run is ahead of us — and it is the last one. Why Bitcoin's next move to $1.6M is also the end of that kind of growth."
published: true
---
...
In a 2014 [interview](https://www.singularityweblog.com/andreas-antonopoulos-on-bitcoin/) on *Singularity 1 on 1*, Andreas Antonopoulos called Bitcoin "money for AI," and in *The Internet of Money* he argues that Bitcoin doesn't care whether an address belongs to a multimillionaire, a central bank, a smart contract, a device, or a human—the core of the "money for machines" argument. That argument has never been more obvious than it is today: AI can't open a bank account, but it can create a Bitcoin wallet.

As you can see, at this point we become seriously constrained by the size of the "pie." Another 20x after that would mean over $600T—more than all the wealth in the world today. Yes, we may eventually colonize other planets and exponential growth will continue, but getting there could take more than 50 years. For an individual investor, that's no longer a particularly inspiring timeframe.

So there you have it: the last 20x. The last run.
...
If you're not there yet—[join us from your dashboard](https://deltabadger.com/dashboard). Join us on the last run.
