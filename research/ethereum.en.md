...
description: "As Ethereum enters its second decade with new all-time highs, stablecoins and institutional ETFs reshape its landscape. Discover how Layer 2 networks are transforming the ecosystem and learn optimal portfolio strategies for capturing this evolution."
thumbnail: ethereum
date: 2025-08-24
published: true
---
...
As we noticed discussing the GENIUS Act, [crypto has a huge growing use case, and it's stablecoins](/research/genius-of-stablecoins). Stablecoins have grown from $6 billion to $270 billion in just 6 years—a 45x increase—while the entire ecosystem now moves $27.6 trillion annually, surpassing Visa and Mastercard combined. 
...
[ETHUSD quotes by TradingView](https://www.tradingview.com/)
...
This expanded throughput has enabled entirely new categories of applications that were previously impossible due to high fees and slow settlement times. Prediction markets like [Polymarket](/research/polymarket) being the best example. For a long-time staying theoretical, they finally materialized.
...
Following the hype around [Bitcoin treasury companies](/research/treasury-companies), with Tom Lee's Ethereum Treasury BitMine (BMNR) accumulating over 1.15 million ETH while publicly targeting 5% of total ETH supply. Unlike Bitcoin treasury companies that rely purely on price appreciation, Ethereum-focused vehicles offer a theoretical advantage through staking yields, potentially providing steady revenue streams for shareholders.
...
More ETFs are coming.[The SEC's approval of the GDLC ETF](/research/grayscale-crypto-etf), opens door for a further regulated exposure to diversified cryptocurrency portfolios that include significant Ethereum allocations.

:::playbook

## Layer 2 Portfolio

At Deltabadger, we're fans of alternative data-driven ways to weight portfolios. While [market cap weighting](/research/market-cap-weighting) remains the most obvious, using TVL (total value locked) as a datapoint has its merits. What's the difference?
